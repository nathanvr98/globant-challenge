...
from app.explore_db import execute_sql_queries, hired_employees_by_quarter, high_performing_departments
...
async def get_employees_by_quarter():
    try:
        ...
        return JSONResponse({"error": f"Error getting the data: {str(e)}"}, status_code=500)
